...
patches {
    about {
        ...
        description = "Custom patches for Smart Launcher 6 (Anti-Tamper Signature Bypass, Contextual Popup Archiving, Settings UI Integration, App Archiving, Privileged Shizuku Integration)."
